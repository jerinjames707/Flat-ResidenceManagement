...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 29, 2023 at 05:56 AM
...
(65, 'Can add announcement_detail', 17, 'add_announcement_detail'),
(66, 'Can change announcement_detail', 17, 'change_announcement_detail'),
(67, 'Can delete announcement_detail', 17, 'delete_announcement_detail'),
(68, 'Can view announcement_detail', 17, 'view_announcement_detail');
...
(17, 'flatresidence', 'announcement_detail'),
...
(26, 'flatresidence', '0008_announcement_detail', '2023-07-22 07:12:33.539537');
...
('1clevrprxauju704x0i4y1e1k0uzayei', 'e30:1qMmkV:oEEp3REWQGglV5ixMEl8LM4lxab2xsftNws0m2FXdBQ', '2023-08-04 09:48:35.435210'),
('28yaeec9966gqqjye2q25tkf33xfmwd8', '.eJyrVsrJT8_MK0lJLUnMzFGyUkpMyc3Mc0jPBfL0kvNzlXQgIjAZpVoAy3IRew:1qGvuH:FkbqeWDWOQUto2PhIQbNZqjlyRZr3puN24Vc0T3SpSw', '2023-07-19 06:22:29.202282'),
('599cy0tulja715ga9h9n04r9d33ujqzr', 'e30:1qHytT:F3rQiOuJ5PXIsDQDFEFGy7CyLHn6dfRU5ZgJTZN4bsY', '2023-07-22 03:45:59.611801'),
('6tj5fbxufevtbsikqyll12xzegdc9vry', 'e30:1qN6yc:Ip_Xy8av_wVjvD8LVdJFW8QziZ564HjUVejK9QmyX5U', '2023-08-05 07:24:30.807720'),
...
('ape0df7fylvvktl0lv4ath523m72lmdv', 'e30:1qPaqQ:RBgpgybrOVKUFz0VzQ6yWWsyg5YJm4KI6dLrbSvVOdM', '2023-08-12 03:42:18.380633'),
...
--
-- Table structure for table `flatresidence_announcement_detail`
--

CREATE TABLE IF NOT EXISTS `flatresidence_announcement_detail` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `flatresidence_announcement_detail`
--

INSERT INTO `flatresidence_announcement_detail` (`id`, `announcement`, `date`) VALUES
(1, 'Flat Residence Day Celebrations', '2023-07-22T12:44');
...
(2, 'Start Gym', '2023-07-22T18:10', '1', 'pending');
...
(1, '1', 'Babu', 'Plumbing in  FLat Number 12D .Urgent Work', '2023-07-06', 'accepted');
